      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-24">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 md:order-2 bg-neutral-100 rounded-2xl h-80 flex items-center justify-center">
              <div className="text-neutral-400 font-mono">Interactive Payment Demo</div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="bg-neutral-100 rounded-2xl h-80 flex items-center justify-center">
              <div className="text-neutral-400 font-mono">Trading Interface Preview</div>
            </div>
            <div>
